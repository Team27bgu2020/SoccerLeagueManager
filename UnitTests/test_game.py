...
class TestGame(TestCase):
    ...
    def test_add_remove_event(self):
        ...
        not_game_event = GameEvent(g, g.get_referees()[0],
    ...
    def test_getters(self):
        ...
        self.assertEqual(self.game.get_home_team(), self.home_team)
        self.assertEqual(self.game.get_away_team(), self.away_team)
        self.assertEqual(self.game.get_field(), self.field)
        self.assertEqual(self.game.get_match_time(), self.d)
        main_ref, refs = self.game.get_referees()
        self.assertEqual(main_ref, self.game._Game__main_referee)
        self.assertEqual(refs, self.game._Game__referees)
        self.assertEqual(self.game.get_score()['home'], self.game._Game__home_score)
        self.assertEqual(self.game.get_score()['away'], self.game._Game__away_score)
