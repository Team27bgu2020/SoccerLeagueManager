...
class AcceptanceTestsSignedUser(TestCase):
    ...
    def test_update_personal_info(self):
        ...
        self.controller.add_fan(user_name, password, 'name', date.datetime(2000, 1, 1))
        ...
        self.assertRaises(ValueError, self.controller.edit_personal_data, user.user_id, user_name, password, invalid_name, valid_birth_date)
