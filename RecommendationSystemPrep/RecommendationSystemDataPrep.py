...
def get_match_features(match, matches, teams, players, x=10):
    ...
    result.loc[0, 'home_buildUp_stats'] = home_build_up_stats
    result.loc[0, 'away_buildUp_stats'] = away_build_up_stats
    result.loc[0, 'home_chanceCreation_stats'] = home_chance_creation_stats
    result.loc[0, 'away_chanceCreation_stats'] = away_chance_creation_stats
